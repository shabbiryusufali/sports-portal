      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)" }}>
            {team.sport.name} · {team.members.length} member
            {team.members.length !== 1 ? "s" : ""} · Captain:{" "}
            {team.captain.user.name ?? team.captain.user.email}
          </p>
        </div>
      </div>
      ...
      >
        {[
          ...
          },
          {
            label: "Win Rate",
            value: `${winRate}%`,
            color: winRate >= 50 ? "var(--accent)" : "#f87171",
          },
        ].map((s) => (
          <div
            key={s.label}
            ...
            {team.events.length === 0 ? (
              ...
              team.events.map((e) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="sp-list-item sp-list-item--hover"
                      style={{ borderTop: "1px solid var(--border)" }}
                    >
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p
            ...
            <section className="sp-card" style={{ overflow: "hidden" }}>
              ...
              {allMatches.slice(0, 8).map((m) => {
                ...
                return (
                  <Link
                    key={m.id}
                    href={m.event ? `/dashboard/events/${m.event.id}` : "#"}
                    style={{ textDecoration: "none" }}
                  >
                    <div
                      className="sp-list-item"
