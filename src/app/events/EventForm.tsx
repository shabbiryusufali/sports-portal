  ...
  return (
    <form
      ...
      action={(fd) => {
        ...
        start(async () => {
          try { await createEvent(fd); }
          catch (e: any) { setErr(e.message ?? "Failed"); }
        });
      }}
    >
      <select name="type" className="border p-2 rounded w-full" defaultValue="practice">
      ...
      <input type="text" name="notes" placeholder="Notes" className="border p-2 rounded w-full" />
